...
void loop() {
  while (true)
    {
      //char* notes = "7G 7G 7G 7A 7Bb7A7Bb7G 7A 7G 7A 7G 7F 7G 7F 7G 7F 7G 7F 7G 7F 7G 7F    ";
      //int lengths[] = {100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100};

      char* notes = 
        "6G    6G    6G    "
        "7A 7Bb7A 7Bb"
        "7A 6G 7A 6G 7A "
        "6G 6F 6G 6F 6G 6F 6G 6F 6G 6F 6G 6F 6G 6F ";
      int lengths[] = {100, 100, 100, 100, 100, 100,
                       150, 150, 150, 150,
                       40, 150, 150, 150, 150, 
                       40, 100, 100, 90, 90, 80, 70, 70, 60, 50, 40, 30, 20, 500};


      for (int index = 0; index <= (sizeof(lengths) / sizeof(int)); index++)
        {
          play_note_name(&notes[index * 3], 5, lengths[index]);
        }
